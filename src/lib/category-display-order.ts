...
export const categoryDisplayItems: CategoryDisplayItem[] = [
  ...
  { id: "tovary-dlya-detey", label: "Товары для детей", href: "/blizhniy/tovary-dlya-detey" },
  ...
  { id: "odezhda-obuv-aksessuary", label: "Одежда, обувь, аксессуары", href: "/blizhniy/odezhda-obuv-aksessuary" },
  ...
  { id: "dlya-doma-i-dachi", label: "Для дома и дачи", href: "/blizhniy/dlya-doma-i-dachi" },
  { id: "instrumenty", label: "Инструменты", href: "/blizhniy/instrumenty" },
  { id: "zhile-dlya-puteshestviya", label: "Жилье для путешествия", href: "/blizhniy/nedvizhimost/zhile-dlya-puteshestviya" },
