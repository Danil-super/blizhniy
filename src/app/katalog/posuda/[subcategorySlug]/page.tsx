...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: subcategory ? `${subcategory.description} Тестовое объявление в подкатегории ${subcategory.name}.` : "Объявления раздела Посуда.",
    alternates: {
        ...
        <section className="mt-3">
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
            <article className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="flex min-h-44 items-center justify-center bg-gradient-to-br from-amber-50 via-white to-blue-50 p-6">
                <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-white text-4xl shadow-sm ring-1 ring-amber-100">🍽️</div>
              </div>
