      ...
      <div className="page-container flex items-center gap-2 pb-3 pt-0 sm:gap-3 md:gap-4 md:pt-2">
        <div className="flex min-w-0 shrink-0 items-center">
          <Link href="/" className="flex min-w-0 shrink-0 items-center gap-1.5 sm:gap-2.5 lg:gap-3.5" aria-label="БЛИЖНИЙ, главная">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center sm:h-11 sm:w-11 md:h-14 md:w-14" aria-hidden="true">
              <LogoMark />
            </span>
            <span className="min-w-0 whitespace-nowrap text-sm font-black tracking-normal text-[#0a1437] sm:text-lg md:text-2xl">
              <BrandName />
            </span>
          </Link>
        </div>
