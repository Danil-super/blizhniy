          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              {adminMode ? (
                ...
                <AdminDemoPublishButton publicationType="workRequest" returnHref="/cabinet/zakazy" label="Сохранить черновик" status="Черновик" requireCaptcha={false} validateForm={false} />
              )}
              <a href="/tarify" className="inline-flex h-12 items-center justify-center rounded-xl border border-slate-300 bg-white px-7 font-bold text-slate-800">
                Посмотреть тарифы
              </a>
            </div>
            </form>
